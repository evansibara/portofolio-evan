/**
 * ColorBends — React Bits official implementation (Three.js)
 * Source: https://reactbits.dev
 *
 * Dependency: three  (install via: npm i three)
 *
 * Catatan: CSS di-inline di dalam file ini, jadi TIDAK perlu file ColorBends.css.
 */
...
export default function ColorBends({
  ...
  useEffect(() => {
    ...
    // Listen on window supaya tetap reaktif walaupun container pointer-events: none
